...
from .views import (
    ...
    add_clinical_summary_view, treat_patient_view, view_invoice_view
)
...
urlpatterns = [
    ...
    path('booking/treat/<int:slot_id>/', treat_patient_view, name='treat_patient_url'),
    path('booking/summary/<int:slot_id>/', add_clinical_summary_view, name='add_prescription_url'),
]